...
PLATFORM="/usr/local/lib/android/sdk/platforms/android-30/android.jar"
...
echo "Compiling..."
javac -d obj -classpath src -bootclasspath $PLATFORM -source 17.0.1 -target 17.0.1 src/com/example/helloandroid/MainActivity.java
javac -d obj -classpath src -bootclasspath $PLATFORM -source 17.0.1 -target 17.0.1 src/com/example/helloandroid/R.java
